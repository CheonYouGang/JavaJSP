...
<div id="qna" style="position:absolute; left:520px; top:93px; width:100px; height:20px; z-index:100; visibility: hidden"> 
  <table width="250" border="0" cellspacing="2" cellpadding="0" height="20" onMouseOver="MM_showHideLayers('Layer1','','hide','Layer2','','show','Layer3','','hide','Layer4','','hide')" onMouseOut="MM_showHideLayers('Layer2','','hide','Layer1','','hide','Layer4','','hide','Layer3','','hide')">
    <tr bgcolor="#EAEAEA">        
	...
	<div align="center"><span class="layerstyle"><a href="../board/reply_list.jsp">자유게시판</a></span> </div>
      ...
      <td width="120" onMouseOver="this.style.backgroundColor='#CDCDCD'" onMouseOut="this.style.backgroundColor=''"> 
	<div align="center"><span class="layerstyle"><a href="../board/reply_list.jsp">회원게시판</a></span> </div>
      </td>
