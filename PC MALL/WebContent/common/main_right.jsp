...
%>
	...
	<tr>
		<td bgcolor=#dddddd><img height=1 src="" width=1>테이블 표시(상품목록)</td>
	</tr>
	<tr>
		<td>
...
<%-- 					<td><font color=red>&nbsp;[<%=price%>&nbsp;원]</font></td> --%>
					<td><font color=red>&nbsp;[<fmt:formatNumber value="<%=price%>" pattern="#,###" />&nbsp;원]</font></td>
				</tr>
			</table>
		</td>
<%
...
<!-- 상품  테이블 표시-->
	<tr>
<!-- 		<td rowspan=3 width=5><img src="" width=8 height=8 border=0>테이블 표시(상품목록)</td> -->
